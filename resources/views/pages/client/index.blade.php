        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-12">
                <div class="text-center mb-5 pb-2">
                    <h1 class="text-dark">Listen to Pod Talk</h1>

                    <p class="text-dark">Listen it everywhere. Explore your fav podcasts.</p>

                    <a href="#section_2" class="btn custom-btn smoothscroll mt-3">Update Info Terbaru 👇</a>
                </div>
            </div>
